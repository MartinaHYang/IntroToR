...
-   **The "Head" of the Script:** Always load your libraries at the top. This acts as a "Required Hardware" list for R.

-   **Function Management:** Keep your main script clean. If you have many custom functions, save them in a file called `utils.R` or `functions.R` and bring them in using `source("functions.R")`.
